      ...
      <div className="contenedor_principal">
        ...
        <div className="flex flex-row flex-wrap justify-center py-3 gap-3">
          ...
          />
           ...
           <select
      onChange={handleDepartamentoChange} // Llamas a la función que maneja el cambio
      value={selectedDepartment} // El valor del select será el estado actual del filtro
